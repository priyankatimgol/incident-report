    ...
    <tbody>
      ...
      <tr style="background: #fff;vertical-align: baseline;">
        <td style="width: 20%;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;" {% if InitialCategoryOccupationalInjury.fatality %} checked {% endif %}  class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Fatality </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  InitialCategoryOccupationalInjury.rwdc %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">RWDC </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  InitialCategoryOccupationalInjury.lti %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">LTI </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  InitialCategoryOccupationalInjury.mtc %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">MTC </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  InitialCategoryOccupationalInjury.firstAid %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
        ...
        <td style="width: 20%;border-left: 1px solid #000;">
          <p style="font-size: 12px;padding-bottom: 10px;"><b>
          Initials Category Occupational Illness:</b></p>
          <div style="display: flex;align-items: center; position: relative;">
        ...
        <td style="width: 20%;border-left: 1px solid #000;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input style="margin: 5px !important;" {% if  InitialPropertyDamage.gasLeakRelease %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
        ...
        <td style="width: 20%;border-left: 1px solid #000;">
          <p style="font-size: 12px;padding-bottom: 10px;"><b>
          The initials Motor Vehicle Crash (MVC)</b></p>
          <div style="display: flex;align-items: center; position: relative;">
  ...
  <table style="border: 1px solid #000;border-top: none;width: 100%;">
    <tbody>
      ...
      <tr style="background: #fff;vertical-align: baseline;">
        ...
        <td style="border-left: 1px solid #000;">
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.struckAgaintsIntoRunningBumpingCollidingGroundingCrashing %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Tools & Equipment </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  CorporateLifeSavingRules.struckByHitByMovingObject %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Safe Zone Position</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.fallFromElevationPersonEquipmentMaterial %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Permit To Work</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.fallOnSameLevelSlipAndFallTripOver %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Isolation</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.caughtInOnBetweenOrUnder %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Confined Space</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  CorporateLifeSavingRules.contactWithNoise %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Lifting Operation</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.failureOfInstrumentationLogicLoop2 %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Others</p></label>
          </div>
        </td>
        <td>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.lossOfPrimaryContainment %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Fit To Work</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.releaseToAirWaterIntoSoilOntoStructure %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Working At Heights</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.firePoolFireJetFireFlashFire %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Personal Floating Device</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  CorporateLifeSavingRules.explosionVapourCloudDustPressureBurstBleve %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">System Override</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if   CorporateLifeSavingRules.failureOfMechanicalEquipment %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Asset Integrity</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input  disabled={true} style="margin: 5px !important;"  {% if  CorporateLifeSavingRules.failureOfInstrumentationLogicLoop1 %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
