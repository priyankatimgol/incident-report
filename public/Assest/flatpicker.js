  ...
  function y(g, h) {
            ...
            if (
              ...
              (D.daysContainer.style.width = n + 'px'),
                (D.calendarContainer.style.width =
                  n + (void 0 !== D.weekWrapper ? D.weekWrapper.offsetWidth : 0) + 'px'),
    ...
    function k(e) {
      ...
      void 0 !== e &&
        ...
        (function (e) {
          ...
          void 0 !== D.amPM &&
            t === D.amPM &&
            (D.amPM.textContent = D.l10n.amPM[r(D.amPM.textContent === D.l10n.amPM[0])]);
          ...
          if (void 0 !== a.value && 2 === a.value.length) {
            var f = a === D.hourElement,
              g = a === D.minuteElement;
            u < i
              ? ((u = l + u + r(!f) + (r(f) && r(!D.amPM))), g && Y(void 0, -1, D.hourElement))
              : u > l &&
    ...
    function T() {
      if (void 0 !== D.hourElement && void 0 !== D.minuteElement) {
        ...
        void 0 !== D.amPM &&
          ((e = t), (n = D.amPM.textContent), (t = (e % 12) + 12 * r(n === D.l10n.amPM[1])));
        var o =
        ...
        if (
          ...
          (t = Math.min(t, l.getHours())) === l.getHours() && (a = Math.min(a, l.getMinutes())),
            a === l.getMinutes() && (i = Math.min(i, l.getSeconds()));
        }
        if (o) {
          var c = void 0 !== D.config.minTime ? D.config.minTime : D.config.minDate;
          (t = Math.max(t, c.getHours())) === c.getHours() && (a = Math.max(a, c.getMinutes())),
    ...
    function F(e, n, t, a) {
      return n instanceof Array
        ...
        : (e.addEventListener(n, t, a),
          void D._handlers.push({ element: e, event: n, handler: t, options: a }));
    }
    function N() {
      ge('onChange');
    }
    function A(e, n) {
      ...
      n && D.currentYear !== a && (ge('onYearChange'), J()),
        !n || (D.currentYear === a && D.currentMonth === i) || ge('onMonthChange'),
        D.redraw();
    }
    function P(e) {
      var n = m(e);
    ...
    function H(e, n, t, a) {
      ...
      return (
        ...
        -1 === e.indexOf('hidden') &&
          0 === C(n, D.now) &&
          ((D.todayDateElem = o), o.classList.add('today'), o.setAttribute('aria-current', 'date')),
        i
          ? ((o.tabIndex = -1),
            he(n) &&
              ...
              'range' === D.config.mode &&
                (d(o, 'startRange', D.selectedDates[0] && 0 === C(n, D.selectedDates[0], !0)),
                d(o, 'endRange', D.selectedDates[1] && 0 === C(n, D.selectedDates[1], !0)),
    ...
    function L(e) {
      for (
        var n = e > 0 ? 0 : D.config.showMonths - 1, t = e > 0 ? D.config.showMonths : -1, a = n;
        a != t;
        a += e
      )
        for (
    ...
    function W(e, n) {
      ...
      void 0 === a
        ...
        ? (function (e, n) {
            for (
              var t = -1 === e.className.indexOf('Month') ? e.dateObj.getMonth() : D.currentMonth,
              ...
              for (
                var r = D.daysContainer.children[o],
                  l = t - D.currentMonth === o ? e.$i + n : n < 0 ? r.children.length - 1 : 0,
                  c = r.children.length,
                  d = l;
                d >= 0 && d < c && d != (n > 0 ? c : -1);
                d += i
    ...
    function R(e, n) {
      ...
      for (var f = i + 1; f <= 42 - t && (1 === D.config.showMonths || u % 7 != 0); f++, u++)
    ...
    function G(e) {
      return (
        !(!D.config.appendTo || !D.config.appendTo.contains(e)) || D.calendarContainer.contains(e)
      );
    }
    function V(e) {
      if (D.isOpen && !D.config.inline) {
        var n = m(e),
          ...
          a =
            ...
            (e.path && e.path.indexOf && (~e.path.indexOf(D.input) || ~e.path.indexOf(D.altInput))),
          i =
            'blur' === e.type
      ...
      if (
        ...
        (D.currentYear = n || D.currentYear),
          D.config.maxDate && D.currentYear === D.config.maxDate.getFullYear()
            ...
            : D.config.minDate &&
              D.currentYear === D.config.minDate.getFullYear() &&
              (D.currentMonth = Math.max(D.config.minDate.getMonth(), D.currentMonth)),
    ...
    function Q(e, n) {
      ...
      if (
        ...
        (D.config.maxDate && t && C(t, D.config.maxDate, void 0 !== n ? n : !D.maxDateHasTime) > 0)
      )
        return !1;
        ...
        switch (e.keyCode) {
          ...
          case 39:
            if (r || t) D.hourElement && D.hourElement.focus();
              ...
              (e.preventDefault(),
              void 0 !== D.daysContainer &&
                (!1 === a || (document.activeElement && X(document.activeElement))))
            ) {
          ...
          case 40:
            ...
            (D.daysContainer && void 0 !== n.$i) || n === D.input || n === D.altInput
              ...
              ? Z(D.currentYear - c)
              : D.config.enableTime &&
                (!r && D.hourElement && D.hourElement.focus(), k(e), D._debouncedChange());
            break;
          case 9:
            if (r) {
    ...
    function te(e) {
      if (
        1 === D.selectedDates.length &&
        (!e ||
          (e.classList.contains('flatpickr-day') && !e.classList.contains('flatpickr-disabled')))
      ) {
        for (
                ...
                return g
                  ...
                  : (['startRange', 'inRange', 'endRange', 'notAllowed'].forEach(function (e) {
                    ...
                    void (
                      void 0 !== e &&
                      (e.classList.add(
                        n <= D.selectedDates[0].getTime() ? 'startRange' : 'endRange',
                      ),
                      t < n && m === t
                      ...
                      m >= r &&
                        (0 === l || m <= l) &&
                        ((d = t), (u = n), (c = m) > Math.min(d, u) && c < Math.max(d, u)) &&
    ...
    function re() {
      'object' != typeof D.config.locale &&
        ...
        D.config.errorHandler(new Error('flatpickr: invalid locale ' + D.config.locale)),
        (D.l10n = e(
          e({}, E.l10ns.default),
          'object' == typeof D.config.locale
            ? D.config.locale
        ...
        (v.K =
          ...
          ')'),
        void 0 === e(e({}, h), JSON.parse(JSON.stringify(g.dataset || {}))).time_24hr &&
    ...
    (D.parseDate = b({ config: D.config, l10n: D.l10n })),
      ...
      (D.close = function () {
        (D.isOpen = !1),
          D.isMobile ||
            (void 0 !== D.calendarContainer && D.calendarContainer.classList.remove('open'),
      ...
      (D.open = function (e, n) {
        ...
        if (!0 === D.isMobile) {
          ...
          return (
            void 0 !== D.mobileInput && (D.mobileInput.focus(), D.mobileInput.click()),
            void ge('onOpen')
          );
        }
    ...
    function ge(e, n) {
      if (void 0 !== D.config) {
        ...
        'onChange' === e &&
          (D.input.dispatchEvent(pe('change')), D.input.dispatchEvent(pe('input')));
      }
    }
    function pe(e) {
        ...
        (D.element = D.input = g),
          ...
          (function () {
            ...
            for (var u = 0; u < n.length; u++)
              D.config[n[u]] = !0 === D.config[n[u]] || 'true' === D.config[n[u]];
            t
              .filter(function (e) {
            ...
            i.altInputClass ||
              (D.config.altInputClass = oe().className + ' ' + D.config.altInputClass);
            ge('onParseConfig');
          })(),
          re(),
          (function () {
            if (((D.input = oe()), !D.input))
              return void D.config.errorHandler(new Error('Invalid input element specified'));
            (D.input._type = D.input.type),
              ...
              D.config.altInput &&
                ...
                !D.config.static &&
                  D.input.parentNode &&
                  D.input.parentNode.insertBefore(D.altInput, D.input.nextSibling));
          ...
          (function () {
            ...
            var e =
              ...
              (('INPUT' !== D.input.nodeName && 'TEXTAREA' !== D.input.nodeName) ||
              !D.input.placeholder ||
                  ...
                  (function () {
                    ...
                    D.config.time_24hr ||
                      ((D.amPM = s(
                        ...
                        D.l10n.amPM[
                          r(
                            (D.latestSelectedDateObj ? D.hourElement.value : D.config.defaultHour) >
                              11,
                          )
                        ],
                      )),
              ...
              if (
                ...
                D.config.inline &&
                  (!i && D.element.parentNode
                    ? D.element.parentNode.insertBefore(D.calendarContainer, D._input.nextSibling)
                    : void 0 !== D.config.appendTo &&
                      D.config.appendTo.appendChild(D.calendarContainer)),
                D.config.static)
              ) {
                var l = s('div', 'flatpickr-wrapper');
                D.element.parentNode && D.element.parentNode.insertBefore(l, D.element),
          ...
          (function () {
            ...
            if (D.isMobile)
              return void (function () {
                ...
                try {
                  D.input.parentNode &&
                    D.input.parentNode.insertBefore(D.mobileInput, D.input.nextSibling);
                } catch (e) {}
          ...
          (D.selectedDates.length || D.config.noCalendar) &&
            (D.config.enableTime &&
              I(D.config.noCalendar ? D.latestSelectedDateObj || D.config.minDate : void 0),
            we(!1)),
          x();
