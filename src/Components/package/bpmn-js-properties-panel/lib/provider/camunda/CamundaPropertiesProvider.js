...
var conditions = require('./parts/ConditionProps');
...
function createConditionElementsGroups(element, bpmnFactory, elementRegistry, translate) {
  var conditionGroup = {
    id: 'conditionElements-properties',
    label: translate('Condition'),
    entries: [],
  };
  properties(conditionGroup, element, bpmnFactory, translate);
...
function createExtensionElementsGroups(element, bpmnFactory, elementRegistry, translate) {
  ...
  //   entries: [],
  // };
  tasklist(element, bpmnFactory, translate);

  if (is(element, 'bpmn:ExclusiveGateway') || is(element, 'bpmn:SequenceFlow')) {
    var conditionGroup = {
      id: 'conditionElements-properties',
      label: translate('Condition'),
      entries: [],
    };
    conditions(conditionGroup, element, bpmnFactory, translate);
    return [conditionGroup];
  } else {
    var propertiesGroup = {
...
function CamundaPropertiesProvider(
  ...
  this.getTabs = function (element) {
    ...
    var coditionTab = {
      ...
      label: translate('Condition'),
      groups: createConditionElementsGroups(element, bpmnFactory, elementRegistry, translate),
    };
