export const Occupationalillness = `
<div>
    ...
    <tbody>
      ...
      <tr style="background: #fff;vertical-align: baseline;">
        ...
        <td style="border-left: 1px solid #000;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input style="margin: 5px !important;"  {% if  CorporateLife.struckByHitByMovingObject %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label disabled={true} class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Safe Zone Position</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
