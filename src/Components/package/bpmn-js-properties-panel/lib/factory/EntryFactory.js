...
var textInputField = require('./TextInputEntryFactory'),
  ...
  selectBoxStatus = require('./SelectEntry'),
  ...
  conditionTableField = require('./TableEntryFactoryCondition'),
...
EntryFactory.selectBoxes = function (options) {
  return selectBoxStatus(options, setDefaultParameters(options));
};
...
EntryFactory.coditionTable = function (options) {
  return conditionTableField(options);
};
