...
export const selectCategory = (value) =>
  !value ? "Select a Category Type" : "";
export const selectStatus = (value) => (!value ? "Select Status Type" : "");
export const selectLocation = (value) =>
  !value ? "Choose Treatment Location" : "";
export const dropDownList = (value) => (!value ? "Choose correct option" : "");
export const formInput = (value) => (!value ? "Field Required" : "");
