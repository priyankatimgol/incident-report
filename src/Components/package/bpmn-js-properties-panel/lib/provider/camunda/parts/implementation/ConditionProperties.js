...
function getPropertiesElementInsideExtensionElements(extensionElements) {
  console.log(
    '🚀 ~ file: ConditionProperties.js ~ line 61 ~ getPropertiesElementInsideExtensionElements ~ extensionElements',
    extensionElements,
  );
...
module.exports = function (element, bpmnFactory, options, translate) {
  ...
  assign(options, {
    ...
    addElement: function (element, node) {
      ...
      if (!properties) {
        ...
        if (!isExtensionElements(parent)) {
          commands.push(
            cmdHelper.updateBusinessObject(element, parent, { properties: properties }),
          );
        } else {
          commands.push(
    ...
    removeElement: function (element, node, idx) {
      ...
      commands.push(
        cmdHelper.removeElementsFromList(element, properties, 'values', null, [currentProperty]),
      );
  ...
  return factory.coditionTable(options);
};
