    ...
    <tbody>
      ...
      <table style="border: 1px solid #000;border-top: none;width: 100%;">
        <tbody>
          ...
          <tr>
        <td colspan="5" style="padding: 0 0.5rem;border-top:1px solid #000;">
  ...
  <table style="border: 1px solid #000;border-top: none;width: 100%;">
    <tbody>
      ...
      <tr style="background: #fff;vertical-align: baseline;">
        ...
        <td>
          <div style="display: flex;align-items: center; position: relative;">
            <input style="margin: 5px !important;"  {% if   CorporateLife.lossOfPrimaryContainment %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
