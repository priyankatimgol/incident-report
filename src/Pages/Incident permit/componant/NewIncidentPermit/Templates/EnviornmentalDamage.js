export const EnviornmentalDamage = `
<div>
    ...
    <tbody>
      ...
      <tr style="background: #fff;vertical-align: baseline;">
        ...
        <td style="width: 20%;border-left: 1px solid #000;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px !important;" {% if  InitialCategory.illness %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Illness</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px !important;" {% if  InitialCategory.illnessFatality %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
            ...
            <tr style="border-bottom: 0.5px solid #000;border-top: 0.5px solid #000;">
              {% for item in data.data %}
                ...
                <td style="padding: 0px;">
                  <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.personalName}}</p>
                </td>
              {% endfor %}
            </tr>
              <tr style="">
                {% for item in data.data %}
                    ...
                    <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.personalAge}}</p>
                    </td>
                {% endfor %}
              </tr>
            {% endfor %}
    ...
    <tbody>
      <tr style="border-bottom: 1px solid #000;background: #fff;vertical-align: baseline;">
        ...
        <td style="border-left: 1px solid #000;">  
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input style="margin: 5px !important;"  {% if  ActivityType.failureOfInstrumentationLogicLoop %} checked {% endif %} class="form-check-input" type="checkbox" id="to" name="to" value="something" >
      ...
      <tr style="background: #fff;vertical-align: baseline;border-top: 1px solid #000;border-bottom: 0.5px solid #000">
      <td style="width: 20%;border-left: 1px solid #000;">
